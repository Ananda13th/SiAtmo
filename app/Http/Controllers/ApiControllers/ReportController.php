...
class ReportController extends Controller
{
    public function LaporanPendapatanBulanan(Request $request)
    {
        if($request->tahun == "")
        {
            return view('laporan/laporanBulananMobile');
        }
        else{
            $query = DB::select(
            ...
            return view('printPreview/pendapatanBulananMobile',  ['bulan'=>$bulan, 'data'=>$query, 'total'=>$totalPendapatan]);
        }
    }
    ...
    public function LaporanServiceTerlaris()
    {
        ...
        return view('printPreview/serviceTerlarisMobile', ['bulan'=>$bulan, 'jumlah'=>$jumlah, 'keterangan'=>$keterangan]);
    }
    public function LaporanPengeluaranBulanan(Request $request)
    {
        ...
        return view('printPreview/pengeluaranBulananMobile',  ['data'=>$query, 'pengeluaran'=>$totalPendapatan]);
    }
    public function LaporanCabang(Request $request)
    {
        ...
        {
            $cabang = Cabang::all();
            return view('laporan/pendapatanCabangMobile', ['cabang'=>$cabang]);
        }
        else{
            ...
            ->where('cabang.namaCabang', 'LIKE', '%'.$request->cabang.'%')
            ...
            return view('printPreview/pendapatanCabangMobile',  ['data'=>$query, 'bulan'=>$label, 'pendapatan'=>$data]);
        }
    }
}